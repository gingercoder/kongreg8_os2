...
(26, 'Kids Church', 'The Kids Church system is based around the use of groups, resources and activities. Placing members into Kids Church Groups allows you to create registers for signing children into and out of your kids church activities. The process for adding children to groups is exactly the same as the primary groups feature. The Kids Church module set has been put together to provide the kids church team with a more flexible and usable interface for keeping track of what''s happening in Kids Church.', 'Kids Church', 0),
(27, 'Kids Church Resources', 'Resources are any items you use for your activities, such as computers, pens, paper, blankets. Keep a track of your resource stock by creating a list of resources and updating them as you use or add to them.', 'Kids Church', 1),
(28, 'Managing Kids Church Groups', 'To add a kids church group, enter the details on the right hand side of the screen just as with the normal groups system. To add members to the kids church groups, click on the view link, then enter the name (or partial name) into the form on the right of the screen. Select the correct name from the list and your member will be added to the group. To remove a group, click on the remove link and confirm it when prompted. To edit the group details, click on Edit and modify your information before saving your new data.', 'Kids Church', 2),
