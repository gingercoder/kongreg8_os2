...
<div class="contentBox">
    ...
    ?>
<p>
    Kids Church Registration - Sign children in and out of Kids Church and create a register output for any date.
</p>
</div>
<div class="contentBox">
    <p>
        <a href="index.php?mid=460&function=signin"><span class="iconSpan"><img src="images/icons/button-check.png" alt="Sign In Child" title="Click to Sign a Child In"/><br/>Sign-in Child</span></a>
        
        
        <a href="index.php?mid=460&function=signout"><span class="iconSpan"><img src="images/icons/button-delete.png" alt="Sign Out Child" title="Click to Sign a Child Out"/><br/>Sign-out Child</span></a>
